...
class Card_list extends React.Component {
  ...
  // 浏览
  cardClick = () => {
    axios.post('/penta/common/view', qs.stringify({ pentaid: this.props.data.pentaid, views: 1, type: 'hy', userid: window.localStorage.getItem('userid') }))
      .then((res) => {
  ...
  // 浏览
  likeClick = () => {
    axios.post('/penta/common/like', qs.stringify({ pentaid: this.props.data.pentaid, type: 'hy', userid: window.localStorage.getItem('userid'), likes: 'likes', likesval: 1 }))
      .then((res) => {
        console.log('ressss', res)
      })
    this.setState({
  ...
  // 浏览
  unlikeClick = () => {
    axios.post('/penta/common/like', qs.stringify({ pentaid: this.props.data.pentaid, type: 'hy', userid: window.localStorage.getItem('userid'), likes: 'unlikes', likesval: 1 }))
      .then((res) => {
        console.log('ressss', res)
      })
    this.setState({
